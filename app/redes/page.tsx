    ...
    <div>
      ...
      <section className="gradient-hero text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Síguenos en Redes Sociales</h1>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {redes.map((red, index) => (
              <a
                ...
                className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm hover:shadow-xl transition group"
              >
                <div className="flex items-start justify-between mb-6">
                  <div className="text-indigo-500 group-hover:text-indigo-600 transition">
                    {red.icono}
                  </div>
                ...
                <div className="flex items-center text-indigo-500 font-semibold group-hover:text-indigo-600 transition">
                  Seguir
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl overflow-hidden">
              ...
              <div className="p-6">
                <span className="text-xs font-semibold text-indigo-500">Instagram</span>
                <h3 className="font-semibold text-slate-800 dark:text-white mt-2 mb-2">
                  5 Métricas que debes seguir en 2026
                </h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Descubre las KPIs esenciales para medir el éxito de tus campañas.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl overflow-hidden">
              ...
              <div className="p-6">
                <span className="text-xs font-semibold text-sky-500">LinkedIn</span>
                <h3 className="font-semibold text-slate-800 dark:text-white mt-2 mb-2">
                  Cómo segmentar tu audiencia B2B
                </h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Estrategias efectivas para llegar a tomadores de decisiones.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl overflow-hidden">
              ...
              <div className="p-6">
                <span className="text-xs font-semibold text-pink-500">TikTok</span>
                <h3 className="font-semibold text-slate-800 dark:text-white mt-2 mb-2">
                  Trends de marketing para este mes
                </h3>
                <p className="text-sm text-slate-600 dark:text-slate-400">
                  Los formatos de video que están dominando las redes.
                </p>
              </div>
            </div>
          </div>
